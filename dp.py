...
def ans_route(clac,ans):
    i = j = itmp = jtmp = 1     # NOT 0(Zero) by line 56
    route =[[iMax-1,jMax-1]]
    flg = 0
    distance = lst[0][0]
...
route = ans_route(calc,ans)
print(route)
print("distance = %d" % calc[jMax-1][iMax-1])
